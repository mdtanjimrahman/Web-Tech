        ...
        <?php
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") 
            {
                ...
                if (isset($_POST['borrow_book']))
                {
                    ...
                    if ($flagUsedToken != 0)
                    {
                        echo "<div class='message error'>Token Already is in use</div>";
                        return;
                    }

                    if (($date2 - $date1) > 10 * 86400 && $flagToken != 1) 
                    {
                        echo "<div class ='message error'>You're not allowed to loan the book for more than 10 day</div>";
                        return;
                    }
                    ...
                    {
                        echo "<div class='message error'>Error updating book quantity</div>";
                        return;                  
                    }
                    ...
                    echo "<p><strong>Token Number:</strong> " . $token . "</p>";
